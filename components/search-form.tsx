        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              required
              className="h-11 px-3 rounded-[8px] border text-sm text-white outline-none transition-all duration-150"
              style={{
                background: '#18181b',
                borderColor: '#3f3f46',
                color: '#ffffff',
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                style={{ background: '#18181b', borderColor: '#3f3f46', color: '#ffffff' }}
                onFocus={(e) => {
                  e.currentTarget.style.borderColor = '#3b82f6'
                  e.currentTarget.style.boxShadow = '0 0 0 3px rgba(59,130,246,0.15)'
                }}
          ...
          <div className="relative">
            ...
            <span
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[0.65rem] select-none pointer-events-none tabular-nums"
